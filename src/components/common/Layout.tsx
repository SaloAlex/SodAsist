        ...
        <main className="flex-1 p-4 lg:p-6 w-full overflow-x-hidden">
          <div className="max-w-7xl mx-auto">
            <Routes>
              ...
              <Route path="/clientes" element={<ProtectedRoute requiredRole={['owner', 'admin', 'manager', 'sodero']}><Clientes /></ProtectedRoute>}>
              ...
              <Route path="/entregas" element={<ProtectedRoute requiredRole={['owner', 'admin', 'manager', 'sodero']}><Entregas /></ProtectedRoute>}>
              ...
              <Route path="/inventario" element={<ProtectedRoute requiredRole={['owner', 'admin', 'manager', 'sodero']}><Inventario /></ProtectedRoute>} />
              <Route path="/reportes" element={<ProtectedRoute requiredRole={['owner', 'admin', 'manager', 'sodero']}><Reportes /></ProtectedRoute>} />
